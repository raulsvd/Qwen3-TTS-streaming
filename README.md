...
See examples/
- [test_streaming_optimized.py](https://github.com/raulsvd/qwen3-tts-streaming/blob/main/examples/test_streaming_optimized.py)
- [test_optimized_no_streaming.py](https://github.com/raulsvd/qwen3-tts-streaming/blob/main/examples/test_optimized_no_streaming.py)
...
```bash
git clone https://github.com/raulsvd/qwen3-tts-streaming.git
